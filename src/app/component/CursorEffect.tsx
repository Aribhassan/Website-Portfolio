    ...
    <>
      {trail.map(function (point, index) {
        ...
        return (
          <div
            key={index}
            className="fixed pointer-events-none rounded-full bg-gradient-to-r from-orange-400 to-orange-700"
            style={{
              left: `${point.x}px`,
              top: `${point.y}px`,
              width: `${20 * scale}px`,
      ...
      <div
        className="fixed pointer-events-none z-50 rounded-full bg-gradient-to-r from-orange-400 to-orange-700"
        style={{
